...
@section('content')
    <div class="container">
        <div class="mb-4">
            <a href="{{ route('downtime.show', $downtime) }}" class="text-blue-600" style="text-decoration: none;">← Geri
                Dön</a>
        </div>
        ...
        <div class="card">
            ...
            <p class="text-sm text-gray-600 mb-4">
                ...
                Hata: <strong>{{ $downtime->errorCode->code ?? 'N/A' }}</strong>
            </p>
            ...
            <form method="POST" action="{{ route('downtime.update', $downtime) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea id="notes" name="notes" class="input @error('notes') input-error @enderror" rows="6"
                        placeholder="Duruş hakkında detaylı bilgi girebilirsiniz...">{{ old('notes', $downtime->notes) }}</textarea>
                    @error('notes')
